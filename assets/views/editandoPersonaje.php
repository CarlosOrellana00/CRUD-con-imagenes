...
<body>
  ...
  ?>
  <div class="container">
    <h1 class="p-3 text-center">Editar Personaje</h1>
    <form action="../php/editarPersonaje.php?idEdit=<?php echo $fila["id"]?>" method="POST" enctype="multipart/form-data">
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <button type="submit" class="btn btn-success">Editar Personaje <i class="fa-solid fa-floppy-disk"></i></button>
